...
class EnsureFocusVisible extends StatefulWidget {
  ...
  @override
  _EnsureFocusVisibleState createState() => _EnsureFocusVisibleState();
}

///
/// We implement the WidgetsBindingObserver to be notified of any change to the window metrics
///
class _EnsureFocusVisibleState extends State<EnsureFocusVisible> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
