...
class ComplexFieldButton extends StatelessWidget {
  /// Function called on Tap Up
  final Function onPressed;
                    ...
                    children: [
                      AnimatedScale(
                        ...
                        child: Container(
                          width: size,
                          height: size,
                          decoration: BoxDecoration(gradient: AppGradients.Foreground, borderRadius: BorderRadius.circular(size / 4.0)),
                          padding: EdgeInsets.all(24),
                        ),
                      ),
                      AnimatedScale(
