...
// ^ Main File Grid Item View ^ //
class _FileGridItemMainView extends StatelessWidget {
  final TransferCardItem item;
  final RxBool isFlipped;
  const _FileGridItemMainView({Key key, this.item, this.isFlipped}) : super(key: key);
...
// ^ Details File Grid Item View ^ //
class _FileGridItemDetailsView extends StatelessWidget {
  final TransferCardItem item;
  final RxBool isFlipped;
  const _FileGridItemDetailsView({Key key, this.item, this.isFlipped}) : super(key: key);
