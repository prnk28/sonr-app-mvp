...
class BottomShareButton extends GetView<NavController> {
  @override
...
class _DefaultView extends GetView<NavController> {
  @override
  Widget build(BuildContext context) {
...
class _ExpandedView extends GetView<NavController> {
  @override
  Widget build(BuildContext context) {
    return Row(
