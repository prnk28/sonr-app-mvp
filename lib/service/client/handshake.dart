...
class _NamebaseClient extends GetConnect {
  ...
  // Endpoint for Blockchain DNS Settings
  final _BLOCK_DNS_POINT = '/api/v0/dns/domains/snr';
  ...
  Future<HSResponse> getBlockchainSettings() async {
    var resp = await get(_BASE_URL + _BLOCK_DNS_POINT, headers: _AUTH_HEADERS);
